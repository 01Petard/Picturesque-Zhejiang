...
//                Toast.makeText(getActivity(), "当前板块是："+city+"，position是:"+tab.getPosition(), Toast.LENGTH_SHORT).show();
            }
    ...
    private void init(){
        //初始化数据
        fragments.clear();
        fragments.add(new ContentFragment("主页",R.layout.viewpage_item1,city));
        fragments.add(new ContentFragment("风景介绍",R.layout.viewpage_item2,city));
        fragments.add(new ContentFragment("历史建筑",R.layout.viewpage_item3,city));
        fragments.add(new ContentFragment("好诗精选",R.layout.viewpage_item4,city));
    }
